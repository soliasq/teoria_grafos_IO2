...
const proyecto = {
  ...
  modalidad: "individual | equipos (máx. 10)",
  objetivo: "Aplicar DFS, BFS, Dijkstra, Kruskal y Prim a un problema real",
  vértices: "|V| ≥ 10",
  aristas: "|E| ≥ 15",
  tecnologías: ["Python", "Java", "JavaScript", "C#", "PHP", "Kotlin", "Flutter"],
...
Situación problemática – Problemas de rutas, conexiones, distribución de recursos, comunicación, transporte, accesibilidad, infraestructura y planificación de redes.

Ejemplos de problemáticas – 12 casos orientativos (distribución, redes, evacuación, fibra óptica, residuos, etc.).

Objetivo general – Diseñar e implementar una aplicación funcional que modele una problemática real mediante grafos y aplique DFS, BFS, Dijkstra, Kruskal y Prim.

Objetivos específicos – 9 puntos clave (identificar, construir, implementar, determinar, obtener, comparar, desarrollar, validar, formular recomendaciones).
...
10.3. Algoritmo de Dijkstra – camino de menor costo, tabla de distancias, predecesores

10.4. Algoritmo de Kruskal – MST por aristas, costo total

10.5. Algoritmo de Prim – MST por nodos, costo total
...
Validar datos incompletos o duplicados.

Mostrar gráficamente la red.

Generar matriz/lista de adyacencia.

Ejecutar DFS, BFS, Dijkstra, Kruskal y Prim.

Resaltar visualmente caminos y árboles.

Mostrar costos y resultados numéricos.

Comparar Kruskal y Prim.

Generar reporte con resultados y recomendaciones.
